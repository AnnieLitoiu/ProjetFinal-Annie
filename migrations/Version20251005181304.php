 ...
 */
final class Version20251005181304 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tentative (id INT AUTO_INCREMENT NOT NULL, quiz_id INT NOT NULL, max_tentatives INT NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME DEFAULT NULL, reponses_correctes INT DEFAULT NULL, reponses_mauvaises INT DEFAULT NULL, reponses_donnees INT DEFAULT NULL, non_repondues INT DEFAULT NULL, pourcentage NUMERIC(10, 0) DEFAULT NULL, reponses_utilisateur JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', INDEX IDX_DBC382F9853CD175 (quiz_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
