 ...
 */
final class Version20260116114203 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_badge (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, quiz_id INT NOT NULL, title VARCHAR(255) NOT NULL, earned_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_1C32B345FB88E14F (utilisateur_id), INDEX IDX_1C32B345853CD175 (quiz_id), UNIQUE INDEX uniq_user_quiz_title (utilisateur_id, quiz_id, title), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE user_badge ADD CONSTRAINT FK_1C32B345FB88E14F FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (id)');
        $this->addSql('ALTER TABLE user_badge ADD CONSTRAINT FK_1C32B345853CD175 FOREIGN KEY (quiz_id) REFERENCES quiz (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_badge DROP FOREIGN KEY FK_1C32B345FB88E14F');
        $this->addSql('ALTER TABLE user_badge DROP FOREIGN KEY FK_1C32B345853CD175');
